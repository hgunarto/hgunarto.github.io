...
function hitungWeton() {
    ...
    const hariJawa = ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];
    ...
    document.getElementById('hasil').innerText =
        `Javanese day is: ${hariJawa[hariIndex]} - ${pasaran[pasaranIndex]}, with neptu: ${neptu}, ` +
        `wuku: ${wukuList[wukuIndex]}, and Javanese calendar: ${tanggalJawa} ${bulanJawa[bulanJawaIndex]} ${tahunJawa}`;
}
